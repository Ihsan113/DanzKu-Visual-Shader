 ...
 * Source: topjohnwu/zygisk-module-sample (public Zygisk API v5).
 * Do not modify the ABI definitions below.
 */
#pragma once
...
struct Api {
    ...
    void pltHookRegister(dev_t dev, dev_t inode, const char *symbol,
...
struct api_table {
    ...
    void (*pltHookRegister)(dev_t, dev_t, const char *, void *, void **);
    bool (*exemptFd)(int);
    bool (*pltHookCommit)();
...
inline void Api::pltHookRegister(dev_t dev, dev_t inode, const char *symbol,
                                 void *newFunc, void **oldFunc) {
